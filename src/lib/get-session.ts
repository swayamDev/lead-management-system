...
//
// Wrapped in cache() since a single request often calls this more than
// once (e.g. the dashboard layout checks the session, then the page
// calls requireUser() again), so this dedupes to one DB round trip.
